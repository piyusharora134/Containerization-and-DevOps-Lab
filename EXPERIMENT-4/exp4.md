...
CMD ["python", "app.py"]
```
![](screenshots/Dockermultistage.png)
...
```
![](screenshots/dockerbuild2.png)

![](screenshots/dockerimges2.png)
...
```
![](screenshots/imagetag.png)

![](screenshots/imagepush.png)
